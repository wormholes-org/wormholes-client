...
//  to 			Account address for recharge
...
//
//	Parameter Description
//	nftAddress: "0x8000000000000000000000000000000000000001",  nft address, the format is a decimal string, when it is SNFT, the length can be less than 42 (including 0x), representing the synthesized SNFT
...
func (nft *NFT) Transfer(nftAddress, to string) (string, error) {
	err := tools.CheckHex("Transfer() nftAddress", nftAddress)
	if err != nil {
		return "", err
	}
...
//
//	Parameter Description
//	nftAddress: "0x0000000000000000000000000000000000000001",	Authorized nft address, the format is a decimal string, when it is SNFT, the length can be less than 42 (including 0x), representing the synthesized SNFT
//	to:         "0x814920c33b1a037F91a16B126282155c6F92A10F",	Licensee's address
func (nft *NFT) Author(nftAddress, to string) (string, error) {
	err := tools.CheckHex("Author() nftAddress", nftAddress)
	if err != nil {
		return "", err
	}
...
//
//	Parameter Description
//	nftAddress: "0x0000000000000000000000000000000000000002",	Authorized nft address, the format is a decimal string, when it is SNFT, the length can be less than 42 (including 0x), representing the synthesized SNFT
//	to:         "0x814920c33b1a037F91a16B126282155c6F92A10F",	Licensee's address
func (nft *NFT) AuthorRevoke(nftAddress, to string) (string, error) {
	err := tools.CheckHex("AuthorRevoke() nftAddress", nftAddress)
	if err != nil {
		return "", err
	}
...
//
//	Parameter Description
//	nftAddress: "0x101060AEFE0d70fB40eda7F4a605c1315Be4A72F",	The converted snft address, in the format of a decimal string, the length can be less than 42 (including 0x), representing the synthesized SNFT
//
...
func (nft *NFT) SNFTToERB(nftAddress string) (string, error) {
	err := tools.CheckHex("SNFTToERB() nftAddress", nftAddress)
	if err != nil {
		return "", err
	}
...
//
//	Parameter Description
//	buyer: { "price":"0xde0b6b3a7640000", "nft_address":"0x0000000000000000000000000000000000000002", "exchanger":"0xe61e5Bbe724B8F449B5C7BB4a09F99A057253eB4", "block_number":"0x487", "sig":"0x24355436e991443b8ed3fb83e8c2fa02f8e2bfc0f716c320f836ee7d756e3c712e7e2510b994d1cb7be85d6643233abc81c23929ce7c1c1effd93db261aac5211b" }																				买家
...
//
//	Parameter Description
//	seller1: { "price":"0x38D7EA4C68000", "nft_address":"0x0000000000000000000000000000000000000003", "exchanger":"0xe61e5Bbe724B8F449B5C7BB4a09F99A057253eB4", "block_number":"0x65d", "sig":"0x94e88fb5686551dfc3006c608423983a248df8502cbbcaeb2c3352f267a25e531d5fc745bea5f7f564b7399fb70d87026bbf9952f1403e9d4dae4aa14b091cff1c" }
...
//
//	Parameter Description
//	{"price":"0xde0b6b3a7640000","nft_address":"0x0000000000000000000000000000000000000004","exchanger":"0xe61e5Bbe724B8F449B5C7BB4a09F99A057253eB4","block_number":"0x930","sig":"0xfa6cac0a88e4792a45b7f743a1f3737d70e4f100e3f8b10a404617fcbaa706130f617e785edc0cc5796758ca2dba82ea422a18b6624b63b4b2ee412713d243651c"}
...
//
//	Parameter Description
//	buyer:  {"price":"0xde0b6b3a7640000","nft_address":"0x0000000000000000000000000000000000000002","exchanger":"0x5051B76579BC966A9480dd6E72B39A4C89c1154C","block_number":"0x11b","sig":"0x158f0ba9dedac427a7746e78aef44ff64c5affa749e56e28793bec6af2a1ff2804a5fd1cce251c84e08674333424a99c8b7497a92f30ed74ceddfc482940ebaa1c"}
//	seller1: {"price":"0xde0b6b3a7640000","nft_address":"0x0000000000000000000000000000000000000002","exchanger":"0x5051B76579BC966A9480dd6E72B39A4C89c1154C","block_number":"0x113","sig":"0x1c8559524220b49e6b9548be405331228d8f26ced8ce12e81b672443fe28067327eef62ce2b3826e2e9ec10f8b2cf5d8a2b2519a0e95f288ea3f098fdea6ab6b1c"}
